...
export default function EmailPage() {
  ...
  return (<div>
    ...
    <div className="bg-sw-card rounded-xl p-5 border border-sw-border max-w-lg">
      ...
      <p className="text-sw-dim text-[11px] mt-3">In production, connects to SendGrid/SMTP to auto-send every {day} at 7 AM with each store's weekly summary.</p>
    </div>
  </div>);
}
